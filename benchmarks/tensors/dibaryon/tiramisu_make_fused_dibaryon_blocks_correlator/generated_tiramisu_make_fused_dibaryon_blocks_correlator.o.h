#ifndef HALIDE__generated_tiramisu_make_fused_dibaryon_blocks_correlator_o_h
#define HALIDE__generated_tiramisu_make_fused_dibaryon_blocks_correlator_o_h
#include <stdint.h>
...
int tiramisu_make_fused_dibaryon_blocks_correlator(struct halide_buffer_t *_buf_C_r_buffer, struct halide_buffer_t *_buf_C_i_buffer, struct halide_buffer_t *_B1_prop_r_b2_buffer, struct halide_buffer_t *_B1_prop_i_b3_buffer, struct halide_buffer_t *_B2_prop_r_b4_buffer, struct halide_buffer_t *_B2_prop_i_b5_buffer, struct halide_buffer_t *_src_psi_B1_r_b6_buffer, struct halide_buffer_t *_src_psi_B1_i_b7_buffer, struct halide_buffer_t *_src_psi_B2_r_b8_buffer, struct halide_buffer_t *_src_psi_B2_i_b9_buffer, struct halide_buffer_t *_snk_psi_B1_r_b10_buffer, struct halide_buffer_t *_snk_psi_B1_i_b11_buffer, struct halide_buffer_t *_snk_psi_B2_r_b12_buffer, struct halide_buffer_t *_snk_psi_B2_i_b13_buffer, struct halide_buffer_t *_hex_src_psi_r_b14_buffer, struct halide_buffer_t *_hex_src_psi_i_b15_buffer, struct halide_buffer_t *_hex_snk_psi_r_b16_buffer, struct halide_buffer_t *_hex_snk_psi_i_b17_buffer, struct halide_buffer_t *_snk_psi_r_b18_buffer, struct halide_buffer_t *_snk_psi_i_b19_buffer, struct halide_buffer_t *_src_spins_b20_buffer, struct halide_buffer_t *_src_spin_block_weights_b21_buffer, struct halide_buffer_t *_sigs_b22_buffer, struct halide_buffer_t *_src_color_weights_b24_buffer, struct halide_buffer_t *_src_spin_weights_b25_buffer, struct halide_buffer_t *_src_weights_b26_buffer, struct halide_buffer_t *_snk_b_b23_buffer, struct halide_buffer_t *_snk_color_weights_b27_buffer, struct halide_buffer_t *_snk_spin_weights_b28_buffer, struct halide_buffer_t *_snk_weights_b29_buffer, struct halide_buffer_t *_hex_snk_color_weights_b30_buffer, struct halide_buffer_t *_hex_snk_spin_weights_b31_buffer, struct halide_buffer_t *_hex_snk_weights_b32_buffer) HALIDE_FUNCTION_ATTRS;
int tiramisu_make_fused_dibaryon_blocks_correlator_old_buffer_t(struct buffer_t *_buf_C_r, struct buffer_t *_buf_C_i, struct buffer_t *_B1_prop_r_b2, struct buffer_t *_B1_prop_i_b3, struct buffer_t *_B2_prop_r_b4, struct buffer_t *_B2_prop_i_b5, struct buffer_t *_src_psi_B1_r_b6, struct buffer_t *_src_psi_B1_i_b7, struct buffer_t *_src_psi_B2_r_b8, struct buffer_t *_src_psi_B2_i_b9, struct buffer_t *_snk_psi_B1_r_b10, struct buffer_t *_snk_psi_B1_i_b11, struct buffer_t *_snk_psi_B2_r_b12, struct buffer_t *_snk_psi_B2_i_b13, struct buffer_t *_hex_src_psi_r_b14, struct buffer_t *_hex_src_psi_i_b15, struct buffer_t *_hex_snk_psi_r_b16, struct buffer_t *_hex_snk_psi_i_b17, struct buffer_t *_snk_psi_r_b18, struct buffer_t *_snk_psi_i_b19, struct buffer_t *_src_spins_b20, struct buffer_t *_src_spin_block_weights_b21, struct buffer_t *_sigs_b22, struct buffer_t *_src_color_weights_b24, struct buffer_t *_src_spin_weights_b25, struct buffer_t *_src_weights_b26, struct buffer_t *_snk_b_b23, struct buffer_t *_snk_color_weights_b27, struct buffer_t *_snk_spin_weights_b28, struct buffer_t *_snk_weights_b29, struct buffer_t *_hex_snk_color_weights_b30, struct buffer_t *_hex_snk_spin_weights_b31, struct buffer_t *_hex_snk_weights_b32) HALIDE_FUNCTION_ATTRS;
