...
void generate_function(std::string name)
{
    ...
    auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&buf_C_r, &buf_C_i,
                                                                                                  ...
                                                                                                  &buf_snk_psi_re,
                                                                                                  &buf_snk_psi_im},
                                                                                                 "generated_tiramisu_make_dibaryon_correlator.o", "./tiramisu_make_dibaryon_correlator_wrapper");
    ...
    as.sample_search_space("./tiramisu_make_dibaryon_correlator_explored_schedules.json", false);
    delete scheds_gen;
    delete exec_eval;
    delete bs;
}
