...
void generate_function(std::string name)
{
   ...
   input snk_weights("snk_weights", {r, wnum}, p_float64);
    ...
    auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({
        ...
        "generated_tiramisu_make_pion_correlator.o", "./tiramisu_make_pion_correlator_wrapper");
    ...
    as.sample_search_space("./tiramisu_make_pion_correlator_explored_schedules.json", false);
    delete scheds_gen;
    delete exec_eval;
    delete bs;
}
