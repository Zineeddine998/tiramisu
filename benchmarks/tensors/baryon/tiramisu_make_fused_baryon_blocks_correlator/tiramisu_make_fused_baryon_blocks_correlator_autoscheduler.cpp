...
void generate_function(std::string name)
{
    ...
    // auto_scheduler::auto_scheduler::create_and_run_auto_scheduler({&buf_C_r, &buf_C_i,
    //                                                                B1_prop_r.get_buffer(), B1_prop_i.get_buffer(),
    //                                                                src_psi_B1_r.get_buffer(), src_psi_B1_i.get_buffer(),
    //                                                                snk_psi_r.get_buffer(), snk_psi_i.get_buffer(),
    //                                                                src_color_weights.get_buffer(),
    ...
    //                                                               "generated_tiramisu_make_fused_baryon_blocks_correlator.o", "./tiramisu_make_fused_baryon_correlator_explored_schedules.json", 1, 2);
