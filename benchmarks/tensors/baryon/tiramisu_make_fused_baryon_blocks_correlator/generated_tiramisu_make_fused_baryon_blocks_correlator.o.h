#ifndef HALIDE__generated_tiramisu_make_fused_baryon_blocks_correlator_o_h
#define HALIDE__generated_tiramisu_make_fused_baryon_blocks_correlator_o_h
#include <stdint.h>
...
int tiramisu_make_fused_baryon_blocks_correlator(struct halide_buffer_t *_buf_C_r_buffer, struct halide_buffer_t *_buf_C_i_buffer, struct halide_buffer_t *_B1_prop_r_b2_buffer, struct halide_buffer_t *_B1_prop_i_b3_buffer, struct halide_buffer_t *_src_psi_B1_r_b4_buffer, struct halide_buffer_t *_src_psi_B1_i_b5_buffer, struct halide_buffer_t *_snk_psi_r_b6_buffer, struct halide_buffer_t *_snk_psi_i_b7_buffer, struct halide_buffer_t *_src_color_weights_b8_buffer, struct halide_buffer_t *_src_spin_weights_b9_buffer, struct halide_buffer_t *_src_weights_b10_buffer, struct halide_buffer_t *_src_spins_b14_buffer, struct halide_buffer_t *_snk_color_weights_b11_buffer, struct halide_buffer_t *_snk_spin_weights_b12_buffer, struct halide_buffer_t *_snk_weights_b13_buffer, struct halide_buffer_t *_sigs_b15_buffer) HALIDE_FUNCTION_ATTRS;
int tiramisu_make_fused_baryon_blocks_correlator_old_buffer_t(struct buffer_t *_buf_C_r, struct buffer_t *_buf_C_i, struct buffer_t *_B1_prop_r_b2, struct buffer_t *_B1_prop_i_b3, struct buffer_t *_src_psi_B1_r_b4, struct buffer_t *_src_psi_B1_i_b5, struct buffer_t *_snk_psi_r_b6, struct buffer_t *_snk_psi_i_b7, struct buffer_t *_src_color_weights_b8, struct buffer_t *_src_spin_weights_b9, struct buffer_t *_src_weights_b10, struct buffer_t *_src_spins_b14, struct buffer_t *_snk_color_weights_b11, struct buffer_t *_snk_spin_weights_b12, struct buffer_t *_snk_weights_b13, struct buffer_t *_sigs_b15) HALIDE_FUNCTION_ATTRS;
