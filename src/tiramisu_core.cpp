...
namespace tiramisu
{
    ...
    */
    ...
    void computation::skew(int L0, int L1, int alpha, int beta, int gamma, int sigma)
    {
        ...
        map = map + "] : " + dimensions_str[0] + " = " + std::to_string(duplicate_ID) + " and " +
              outDim0_str + " = (" + inDim0_str + "*" + std::to_string(alpha) + " + " + inDim1_str + "*" + std::to_string(beta) + " ) and " + outDim1_str + " = (" + inDim0_str + "*" + std::to_string(gamma) + " + " + inDim1_str + "*" + std::to_string(sigma) + " ) }";
