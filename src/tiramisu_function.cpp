...
#define USE_HALIDE_BUFFERS_BUG_WORKAROUND true
    ...
    bool tiramisu::function::loop_vectorization_is_legal(tiramisu::var i, std::vector<tiramisu::computation *> fuzed_computations)
    {
        ...
        bool result = this->loop_unrolling_is_legal(i, fuzed_computations) && this->loop_parallelization_is_legal(i, fuzed_computations);
    ...
    std::tuple<
        ...
        std::vector<std::pair<int, int>>,
        std::vector<std::pair<int, int>>>
    tiramisu::function::skewing_local_solver(std::vector<tiramisu::computation *> fuzed_computations,
