...
namespace tiramisu::auto_scheduler
{
  ...
  // const std::vector<optimization_type> DEFAULT_OPTIMIZATIONS_ORDER = {FUSION, INTERCHANGE, SKEWING, PARALLELIZE, TILING, UNROLLING};
  const std::vector<optimization_type> DEFAULT_OPTIMIZATIONS_ORDER = {FUSION, PARALLELIZE, INTERCHANGE, TILING, UNROLLING};
