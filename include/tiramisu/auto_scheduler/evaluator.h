...
namespace tiramisu::auto_scheduler
{
    ...
    protected:
        ...
        /**
         * The pointer to the generated tiramisu function we need to call to get
         */
        std::function<int(halide_buffer_t *, halide_buffer_t *)> function;

        /**
         * The halide buffers to we need to pass the tiramisu function we need to call
         */
